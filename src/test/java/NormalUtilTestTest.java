    ...
    public void testGetJson() {
        ...
        try {
            ...
            for ( int i = 0; i <= itemsArray.size(); i++) {
                ...
                String phoneno = String.valueOf(items.getAsJsonPrimitive("phoneno"));
